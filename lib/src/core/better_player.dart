    ...
    return VisibilityDetector(
      ...
      child: GestureDetector(
        onScaleEnd: (details) => setState(() {
          widget.controller.onScaleEnd(details);
        }),
        onScaleUpdate: (details) => widget.controller.onScaleUpdate(details),
        onScaleStart: (details) => widget.controller.onScaleStart(details),
